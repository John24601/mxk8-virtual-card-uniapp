...
export function getEnvBaseUrl() {
    ...
    const VITE_SERVER_BASEURL__WEIXIN_DEVELOP = 'https://api.mxk8.com'
    const VITE_SERVER_BASEURL__WEIXIN_TRIAL = 'https://api.mxk8.com'
    const VITE_SERVER_BASEURL__WEIXIN_RELEASE = 'https://api.mxk8.com'
